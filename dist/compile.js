...
function runParcel() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const config = {
            entries: config_1.paths.tmpBundleEntry,
            defaultConfig: Object.assign(Object.assign({}, defaultConfigContents), { filePath: require.resolve('@parcel/config-default') }),
            targets: {
                main: {
                    distDir: config_1.paths.distStatic,
                }
            },
            distDir: config_1.paths.distStatic,
        };
        const bundler = new core_1.default(config);
        yield bundler.run();
    });
}
